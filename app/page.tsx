...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center p-5 md:p-24">
      <h1 className="text-xl md:text-4xl font-bold text-center mb-20">
        ...
        <button className='bg-slate-500 hover:bg-slate-700 text-white font-bold py-2 px-4 rounded mt-5' onClick={handleClear}>Clear {items.length} items</button>
    </main>
  )
}
